                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                        ...
                        <div class="lg:px-10">
                            <form ref="form" @submit.prevent="sendMessage" class="flex flex-col space-y-2">
                                <input type="text" name="user_name" v-model="message.name" placeholder="Name*" class="text-xl text-white w-full rounded-lg bg-sky-800/50 py-2 px-4 outline-none  placeholder:text-white/50">
                                <input type="email" name="user_email" v-model="message.email" placeholder="Email*" class="text-xl text-white w-full rounded-lg bg-sky-800/50 py-2 px-4 outline-none  placeholder:text-white/50">
                                ...
                                <button type="submit" class="px-4 py-2 rounded-md bg-sky-800 sm:w-fit text-white uppercase hover:bg-sky-900 ">
