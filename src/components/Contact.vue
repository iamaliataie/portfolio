                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                        ...
                        <div class="lg:px-10">
                            <form ref="form" @submit.prevent="sendMessage" class="flex flex-col space-y-2">
                                <input type="text" name="user_name" v-model="message.name" placeholder="Name*" class="text-xl text-white w-full rounded-lg bg-sky-800/50 py-2 px-4 outline-none  placeholder:text-white/50 focus:bg-sky-900 transition duration-150">
                                <input type="email" name="user_email" v-model="message.email" placeholder="Email*" class="text-xl text-white w-full rounded-lg bg-sky-800/50 py-2 px-4 outline-none  placeholder:text-white/50 focus:bg-sky-900 transition duration-150">
                                <textarea name="message" v-model="message.message" placeholder="Message*" class="text-xl text-white w-full rounded-lg bg-sky-800/50 px-4 py-2 outline-none placeholder:text-white/50 resize-none focus:bg-sky-900 transition duration-150" rows="4" ></textarea>
