            ...
            <div class="grid grid-cols-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
                <div
                    ...
                    <div class="col-span-1 p-4 sm:p-2">
                        <img src="../assets/sk/python.png" alt="python" class="w-fit h-full">
                    </div>
                    <div
                ...
                <div
                    class="grid grid-cols-1 sm:grid-cols-4 bg-white dark:bg-slate-900 rounded-lg sm:rounded-2xl overflow-hidden shadow-xl dark:border dark:border-slate-700">
                    <div class="col-span-1 p-4 sm:p-2">
                        <img src="../assets/sk/js.png" alt="javascript" class="w-fit h-full">
                    </div>
                    <div
                ...
                <div
                    class="grid grid-cols-1 sm:grid-cols-4 bg-white dark:bg-slate-900 rounded-lg sm:rounded-2xl overflow-hidden shadow-xl dark:border dark:border-slate-700">
                    <div class="col-span-1 p-4 sm:p-2">
                        <img src="../assets/sk/vue.png" alt="vue" class="w-fit h-full">
                    </div>
                    <div
                ...
                <div
                    class="grid grid-cols-1 sm:grid-cols-4 bg-white dark:bg-slate-900 rounded-lg sm:rounded-2xl overflow-hidden shadow-xl dark:border dark:border-slate-700">
                    <div class="col-span-1 p-4 sm:p-2">
                        <img src="../assets/sk/tailwind.png" alt="tailwindcss" class="w-fit h-full">
                    </div>
                    <div
                ...
                <div
                    class="grid grid-cols-1 sm:grid-cols-4 bg-white dark:bg-slate-900 rounded-lg sm:rounded-2xl overflow-hidden shadow-xl dark:border dark:border-slate-700">
                    <div class="col-span-1 p-4 sm:p-2">
                        <img src="../assets/sk/bootstrap.png" alt="bootstrap" class="w-fit h-full">
                    </div>
                    <div
                ...
                <div
                    class="grid grid-cols-1 sm:grid-cols-4 bg-white dark:bg-slate-900 rounded-lg sm:rounded-2xl overflow-hidden shadow-xl dark:border dark:border-slate-700">
                    <div class="col-span-1 p-4 sm:p-2">
                        <img src="../assets/sk/supabase.png" alt="" class="w-fit h-full">
                    </div>
                    <div
                        class="col-span-3 bg-emerald-500 py-2 sm:p-0 sm:rounded-xl flex justify-center items-center w-full h-full">
                ...
                <div
                    class="grid grid-cols-1 sm:grid-cols-4 bg-white dark:bg-slate-900 rounded-lg sm:rounded-2xl overflow-hidden shadow-xl dark:border dark:border-slate-700">
                    <div class="col-span-1 p-4 sm:p-2">
                        <img src="../assets/sk/postgres.png" alt="" class="w-fit h-full">
                    </div>
                    <div
                ...
                <div
                    class="grid grid-cols-1 sm:grid-cols-4 bg-white dark:bg-slate-900 rounded-lg sm:rounded-2xl overflow-hidden shadow-xl dark:border dark:border-slate-700">
                    <div class="col-span-1 p-4 sm:p-2">
                        <img src="../assets/sk/xd.png" alt="" class="w-fit h-full">
                    </div>
                    <div
